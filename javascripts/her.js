$(function() {
    ...
    function tagEventHandler(evt) {
        ...
        $.post('http://api.xingwu.me/proposal/add_comment', {id: 'yy', comment: orig[0]});
    }
    
    $.getJSON('http://api.xingwu.me/proposal/get_comments/yy', function(rsp){
        if (rsp.ret === 0) {
    ...
    $('#comment-form').submit(function(evt) {
        evt.preventDefault();
        $.post('http://api.xingwu.me/proposal/add_comment', {id:'yy', comment:$('#textField').val()});
        $('#tagBox').modal('hide');
